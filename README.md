> **Note:** The Test Strategy for this project can be found in the [`TestStrategy.md`](TestStrategy.md) file. This document (`README.md`) only contains the practical instructions for running the demonstration patches.
