> **Note:** The Test Strategy for this project can be found in the [`Test Strategy`](Test Strategy.md) file. This document (`README.md`) only contains the practical instructions for running the demonstration patches.
